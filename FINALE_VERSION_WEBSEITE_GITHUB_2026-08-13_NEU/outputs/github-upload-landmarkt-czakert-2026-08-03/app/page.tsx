                ...
                <img
                  ...
                  alt={
                    product.id === "mehl" && flourImageIndex === 1
                      ...
                      : (product.id === "loeckchen-500" && curlsImageIndex === 1) ||
                          (product.id === "band-500" && ribbonImageIndex === 1)
                        ? "Inhalts- und Nährwertangaben der Dinkelvollkornpasta"
                ...
                {product.id === "loeckchen-500" && (
                  <>
                    <button
                      ...
                      aria-label="Vorheriges Bild der Pasta Löckchen anzeigen"
                    >
                      ‹
                    </button>
                    <button
                      ...
                      className="product-gallery-arrow product-gallery-arrow-right"
                      onClick={() => setCurlsImageIndex((current) => (current === 0 ? 1 : 0))}
                      aria-label="Nächstes Bild der Pasta Löckchen anzeigen"
                    >
                      ›
                    </button>
                  </>
                ...
                {product.id === "band-500" && (
                  <>
                    <button
                      ...
                      aria-label="Vorheriges Bild der Pasta Band gewellt anzeigen"
                    >
                      ‹
                    </button>
                    <button
                      ...
                      className="product-gallery-arrow product-gallery-arrow-right"
                      onClick={() => setRibbonImageIndex((current) => (current === 0 ? 1 : 0))}
                      aria-label="Nächstes Bild der Pasta Band gewellt anzeigen"
                    >
                      ›
                    </button>
                  </>
