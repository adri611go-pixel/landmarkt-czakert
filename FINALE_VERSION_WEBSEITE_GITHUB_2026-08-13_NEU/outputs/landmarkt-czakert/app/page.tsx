...
export default function Home() {
  ...
  function submitOrder(event: FormEvent<HTMLFormElement>) {
    ...
    window.location.href = `mailto:landmarkt.czakert@gmail.com?subject=${encodeURIComponent(
    ...
    <main>
        ...
        <div className="cooperation-callout">
          ...
          <div>
            ...
            <div className="cooperation-links">
              <a href="mailto:landmarkt.czakert@gmail.com">E-Mail schreiben →</a>
              <a
                href="https://wa.me/491719328099?text=Hallo%20Landmarkt%20Czakert%2C%20ich%20interessiere%20mich%20f%C3%BCr%20eine%20Zusammenarbeit."
                target="_blank"
                rel="noreferrer"
              >
                Per WhatsApp melden →
      ...
      <section className="order section" id="bestellen">
        ...
        <form className="order-form" onSubmit={submitOrder}>
              ...
              {products.map((product) => (
                <div className="order-row" key={product.id}>
                  <div>
                    ...
                    <span>{product.detail} · {euro.format(product.price)}</span>
                  </div>
                  <label>
          ...
          <label className="consent">
            ...
            />
            <span>
              Ich bestelle die ausgewählten Produkte verbindlich und
              kostenpflichtig.{" "}
              {deliveryMethod === "shipping"
      ...
      <section className="instagram">
        ...
        <div>
          ...
          <a
            ...
            rel="noreferrer"
          >
            Instagram @landmarktczakert <span aria-hidden="true">↗</span>
          </a>
        </div>
      </section>
      ...
      <footer>
        ...
        <div>
          ...
          <a href="mailto:landmarkt.czakert@gmail.com">landmarkt.czakert@gmail.com</a>
