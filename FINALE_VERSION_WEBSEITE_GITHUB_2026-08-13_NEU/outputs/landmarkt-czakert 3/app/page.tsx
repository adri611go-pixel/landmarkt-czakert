...
export default function Home() {
  const [flourImage, setFlourImage] = useState(0);
        ...
        <div className="product-grid">
          {products.filter((product) => product.showcase).map((product, index) => (
            <article className="product-card" key={product.id}>
              <div className={`product-image${product.id === "mehl" ? " product-gallery" : ""}`}>
                <img
                  className={product.id === "mehl" && flourImage === 1 ? "nutrition-image" : ""}
                  src={product.id === "mehl" && flourImage === 1 ? "/inhaltsangaben-dinkelvollkornmehl.png" : product.image}
                  alt={
                    product.id === "mehl" && flourImage === 1
                ...
                {product.id === "mehl" && (
                  <>
                    <button
                      ...
                      onClick={() => setFlourImage((current) => (current === 0 ? 1 : 0))}
                    >
                      ‹
                    </button>
                    <button
                    ...
                    <div className="gallery-dots" aria-hidden="true">
                      <i className={flourImage === 0 ? "active" : ""} />
                      <i className={flourImage === 1 ? "active" : ""} />
                    </div>
                  </>
                )}
              </div>
        ...
        <form className="order-form" onSubmit={submitOrder}>
          ...
          <label className="consent">
            ...
            <span>
              ...
              Reservierungsanfrage ist, und stimme der Verarbeitung meiner
